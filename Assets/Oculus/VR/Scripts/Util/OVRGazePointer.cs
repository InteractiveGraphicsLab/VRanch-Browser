...
public class OVRGazePointer : OVRCursor {
    ...
    void Update ()
    {
        ...
        line.SetPosition(0, rayTransform.position + rayTransform.forward * 0.035f);
        line.SetPosition(1, rayTransform.position + rayTransform.forward * (depth < 0.4f ? Mathf.Max(depth - 0.01f, 0.035f) : 0.4f));
    ...
    public override void SetCursorStartDest(Vector3 _, Vector3 pos, Vector3 normal)
    {
        ...
        currentScale = Mathf.Max(depth * depthScaleMultiplier, 0.25f);
